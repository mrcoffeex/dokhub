    ...
    <AdminLayout>
        <template #header>
            <div class="flex items-center gap-2">
                ...
                <h1 class="text-lg font-semibold text-gray-900">Edit Dr. {{ doctor.name }}</h1>
            </div>
        </template>
        ...
        <div class="mx-auto max-w-2xl">
            <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <button
                                ...
                                :class="selectedDays.includes(idx) ? 'border-violet-600 bg-violet-600 text-white shadow-sm' : 'border-gray-200 text-gray-600 hover:border-gray-300'"
                            >
                                {{ day.slice(0, 3) }}
                            </button>
                        </div>
                ...
                <div class="flex items-center justify-end gap-3">
                    <a href="/admin/doctors" class="rounded-xl border border-gray-200 px-5 py-2.5 text-sm font-medium text-gray-600 hover:bg-gray-50">Cancel</a>
