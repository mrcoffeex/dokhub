    ...
    <AdminLayout>
        ...
        <div class="mx-auto max-w-2xl space-y-6">
                ...
                >
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            >
                                Your email is unverified. A new verification
                                link will be sent on save.
                            </p>
                        </div>
                    </div>
            ...
            >
                ...
                >
                    <div
                        class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-amber-50 dark:bg-amber-900/20"
                    >
                        <svg
                ...
                >
                    ...
                    <div class="mt-6 flex justify-end">
                        <button
                            ...
                            class="inline-flex items-center gap-2 rounded-xl bg-amber-500 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-amber-600 focus:ring-2 focus:ring-amber-400 focus:ring-offset-2 focus:outline-none active:scale-95 disabled:opacity-60 dark:focus:ring-offset-gray-900"
                        >
                            <svg
