...
const selectedDays = ref<number[]>(
    props.doctor.schedules?.filter(s => s.is_active).map(s => s.day_of_week) ?? [1, 2, 3, 4, 5]
);
    ...
    <AdminLayout>
        <template #header>
            <div class="flex items-center gap-2">
                <a href="/admin/doctors" class="text-sm text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">Doctors</a>
                <span class="text-gray-300 dark:text-gray-600">/</span>
                <h1 class="text-lg font-semibold text-gray-900 dark:text-white">Edit Dr. {{ doctor.name }}</h1>
            </div>
        </template>
        ...
        <div class="mx-auto max-w-2xl">
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                    <h2 class="mb-5 font-semibold text-gray-900 dark:text-white">Doctor Information</h2>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Specialization <span class="text-red-500">*</span></label>
                                <div class="mt-1.5 max-h-48 overflow-y-auto rounded-xl border border-gray-200 p-3 dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input v-model.number="form.experience_years" type="number" min="0"
                                    class="mt-1.5 w-full rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-900 outline-none transition focus:border-violet-400 focus:ring-2 focus:ring-violet-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 dark:focus:border-violet-500 dark:focus:ring-violet-900/30" />
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <textarea v-model="form.bio" rows="3"
                                class="mt-1.5 w-full resize-none rounded-xl border border-gray-200 bg-white px-4 py-2.5 text-sm text-gray-900 outline-none transition focus:border-violet-400 focus:ring-2 focus:ring-violet-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 dark:focus:border-violet-500 dark:focus:ring-violet-900/30" />
                        </div>
                ...
                <!-- Schedule -->
                <div class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                    <h2 class="mb-5 font-semibold text-gray-900 dark:text-white">Weekly Schedule</h2>
                    <div class="mb-5">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <button
                                ...
                                :class="selectedDays.includes(idx) ? 'border-violet-600 bg-violet-600 text-white shadow-sm' : 'border-gray-200 text-gray-600 hover:border-gray-300 dark:border-gray-700 dark:text-gray-300 dark:hover:border-gray-500'"
                            >
                                {{ day.slice(0, 3) }}
                            </button>
                        </div>
                    ...
                    <div class="grid gap-4 sm:grid-cols-3">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Slot Duration</label>
                ...
                <div class="flex items-center justify-end gap-3">
                    <a href="/admin/doctors" class="rounded-xl border border-gray-200 px-5 py-2.5 text-sm font-medium text-gray-600 transition hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800">Cancel</a>
