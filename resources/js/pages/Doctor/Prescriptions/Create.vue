    ...
    searchTimer = setTimeout(async () => {
        ...
        try {
            const res = await fetch(
                `/api/medicines/search?q=${encodeURIComponent(term)}`,
            ...
            <div class="min-w-0 flex-1">
                <div class="mx-auto max-w-2xl space-y-5">
                    ...
                    >
                        <!-- Card header -->
                        <div
                            class="flex items-center justify-between border-b border-gray-100 bg-gray-50/60 px-5 py-3.5 dark:border-gray-800 dark:bg-gray-800/40"
                        >
                        ...
                        <form @submit.prevent="submit">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            type="button"
                                            @click="removeMed(i)"
                                            class="flex items-center gap-1 rounded-lg border border-red-100 bg-red-50 px-2.5 py-1 text-xs font-medium text-red-500 opacity-0 transition group-hover:opacity-100 hover:bg-red-100 hover:text-red-700 dark:border-red-900/30 dark:bg-red-900/20 dark:text-red-400"
                                        >
                                            <svg
                                                class="h-3 w-3"
                                                fill="none"
                                    ...
                                    <div class="grid gap-3 sm:grid-cols-2">
                                        ...
                                        <div class="relative sm:col-span-2">
                                            <label
                                                class="mb-1.5 block text-xs font-semibold text-gray-600 dark:text-gray-400"
                                            >
                                                Medicine Name
                                            ...
                                            >
                                                <div
                                                    v-if="
                                                        ...
                                                        activeFieldIndex === i
                                                    "
                                                    class="absolute top-full right-0 left-0 z-30 mt-1.5 origin-top overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl dark:border-gray-700 dark:bg-gray-900"
                                                >
                                                    <div
                                                        v-if="isSearching"
                                                    ...
                                                    <div
                                                        v-else-if="
                                                            ...
                                                            suggestions.length ===
                                                                0
                                                        "
                                                        class="flex items-center gap-3 px-4 py-3.5 text-sm text-gray-400 dark:text-gray-500"
                                                    >
                                                        <svg
                                                    ...
                                                    <template v-else>
                                                        <div
                                                            class="border-b border-gray-100 px-3 py-1.5 dark:border-gray-800"
                                                        >
                                                            <p
                            ...
                            <div
                                class="border-t border-dashed border-gray-200 px-5 py-3 dark:border-gray-700"
                            >
                                <button
                                    type="button"
                                    @click="addMed"
                            ...
                            >
                                <label
                                    class="mb-1.5 block text-sm font-semibold text-gray-800 dark:text-white"
                                >
                                    <span
                                        class="mr-1.5 inline-flex h-5 w-5 items-center justify-center rounded bg-gray-100 dark:bg-gray-700"
                                    >
                                        <svg
                            ...
                            <!-- Actions -->
                            <div
                                class="flex flex-wrap items-center gap-3 border-t border-gray-100 px-5 py-4 dark:border-gray-800"
                            >
                                <button
                                    type="submit"
                                ...
                                <Link
                                    :href="`/doctor/patients/${patient.id}`"
                                    class="rounded-xl border border-gray-200 px-6 py-2.5 text-sm font-medium text-gray-600 transition hover:bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-800"
                                >
                                    Cancel
                                </Link>
                                <div
                                    class="ml-auto flex items-center gap-1.5 text-xs text-gray-400 dark:text-gray-500"
                                >
                                    <svg
                                        class="h-3.5 w-3.5"
                                        fill="none"
            ...
            <div class="hidden w-[520px] shrink-0 xl:block">
                <div class="sticky top-6">
                    ...
                    <div class="mb-3 flex items-center justify-between">
                        ...
                        <span
                            class="rounded-full border border-amber-200 bg-amber-50 px-2.5 py-0.5 text-xs font-semibold text-amber-600 dark:border-amber-700 dark:bg-amber-900/30 dark:text-amber-400"
                        >
                            DRAFT
                        </span>
                    </div>
                    ...
                    <div
                        class="overflow-hidden rounded-2xl border border-gray-200 bg-white text-[13px] shadow-sm dark:border-gray-700 dark:bg-gray-900"
                    >
                        <!-- Letterhead -->
                        <div
                        ...
                        >
                            <div>
                                ...
                                <p
                                    ...
                                    class="mt-0.5 text-xs text-gray-500 dark:text-gray-500"
                                >
                                    {{ doctor.location }}
                                </p>
                            </div>
                            <div class="text-right">
                                <p
                                    class="mb-0.5 text-xs font-semibold tracking-wider text-gray-400 uppercase dark:text-gray-500"
                                >
                                    Prescription
                                </p>
                                <p
                        ...
                        <!-- Patient info -->
                        <div
                            class="grid grid-cols-3 gap-4 border-b border-gray-100 bg-gray-50 px-6 py-4 dark:border-gray-800 dark:bg-gray-800/50"
                        >
                            <div>
                                <p
                                    class="mb-0.5 text-xs font-semibold tracking-wider text-gray-400 uppercase dark:text-gray-500"
                        ...
                        <div class="px-6 py-5">
                            ...
                            >
                                ...
                                >
                                    Medications will appear here as you type
                                </p>
                            </div>
                            ...
                            <table v-else class="w-full">
                                <thead>
                                    ...
                                    >
                                        <th
                                            class="pb-1.5 text-left text-xs font-bold tracking-wider text-gray-700 uppercase dark:text-gray-300"
                                        >
                                            #
                                        </th>
                                        <th
                                ...
                                >
                                    ...
                                    >
                                        <td
                                            class="py-2 pr-2 font-medium text-gray-400 dark:text-gray-600"
                                        >
                                            {{ i + 1 }}.
                                        </td>
                                        <td
                                            class="py-2 pr-2 font-semibold text-gray-900 dark:text-white"
                                        >
                                            <span v-if="med.name">{{
                                                med.name
                                            }}</span>
                                            <span
                                                v-else
                                                class="text-gray-300 italic dark:text-gray-700"
                                                >—</span
                                            >
                                        </td>
                                        <td
                                            class="py-2 pr-2 text-gray-700 dark:text-gray-300"
                                        >
                                            {{ med.dosage || '—' }}
                                        </td>
                                        <td
                                        ...
                                        <td
                                            class="py-2 text-gray-700 dark:text-gray-300"
                                        >
                                            {{ med.duration || '—' }}
                                        </td>
                                    </tr>
                            ...
                            <div
                                v-if="
                                    form.medications.some((m) => m.instructions)
                                "
                            ...
                            <div
                                v-if="form.notes"
                                class="mt-4 rounded-xl border border-amber-200 bg-amber-50 p-3.5 dark:border-amber-800/40 dark:bg-amber-900/20"
                            >
                                <p
                        ...
                        <!-- Signature footer -->
                        <div
                            class="flex items-end justify-between border-t border-gray-200 px-6 py-4 dark:border-gray-700"
                        >
                            <div
                                class="text-xs text-gray-400 dark:text-gray-600"
                            >
                    ...
                    <p
                        class="mt-2 text-center text-xs text-gray-400 dark:text-gray-600"
                    >
                        Preview updates as you type · Final output matches this
                        layout
                    </p>
                </div>
            </div>
